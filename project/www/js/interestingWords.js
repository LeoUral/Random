...
const renderMenuWords = `<div class="main-block-menu">
                        <div>Cлучайность из категории:<span class="cat-sel">Интересные слова</span></div>
                        <div>
...
class Words {
    ...
    async _requestMeaningWords() {

        const url = "./js/words.json";
    ...
    init() {
        ...
        this.runProgrWords();
        this._requestMeaningWords();
        setTimeout(function () {
            words.choiceOfWords();
            // words.renderTextWord();
        }, 100);
    }
